package main;
  ...
  * @return this.coordinates     Returns all obtained coordinates
  * @return this.coordinate[0]   Returns the coordinates obtained from X at 0
  * @return this.coordinate[1]   Returns the coordinates obtained from Y at 1
  */
